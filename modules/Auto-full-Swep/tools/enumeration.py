...
def main():
    if len(sys.argv) != 3:
        print("Usage: ./enumeration.py <ip_address> <port>")
        sys.exit(1)
    ...
    output_dir = f"{get_output_base()}/{ip}/enumeration"
    ...
    print("================[ ENUMERATION MENU ]================")
    print("[1] Basic Port Scan (3s default)")
